    ...
    <>
     <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
            <div className="text-center px-6">
                <h2 className=" text-4xl tracking-tight font-extrabold  sm:text-[40px]/[48px] text-gray-900 dark:text-white relative block text-[50px] leading-[60px] ">Contact Us</h2>
                <p className="text-sm text-gray-500 mt-4">To make your journey with us memorable</p>
            </div>
                ...
                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul className="mt-16 space-y-8">
                        <li className="flex items-center">
                            ...
                            <Link href="javascript:void(0)" className="text-white text-sm text-gray-500 ml-4">
                            afonlinetravelagency@gmail.com    mdnayemhussainshuvo@gmail.com
                            </Link>
                        </li>
                        <li className="flex items-center">
                        ...
                        <li className="flex items-center">
                            ...
                            <Link href="javascript:void(0)" className="text-white text-sm text-gray-500 ml-4">
                            05, Joymot khan road ,Tongi Gazipur ,Dhaka 
                            </Link>
                        </li>
                    </ul>
